 ...
 * <p>
 * To create user-defined functions, derive from this class and override one of
 * the eval() methods.
 * <p>
 * 
...
abstract public class Function {
	 ...
	 * otherwise returns NaN. This allow calling any real functions as a
	 * (restricted) complex one.
	 */
	...
	public Complex eval(Complex x, Complex y) {
		checkArity(2);
		return new Complex(x.im == 0 && y.im == 0 ? eval(x.re, y.re)
				: Double.NaN, 0);
	}
	...
	public void checkArity(int nArgs) throws ArityException {
		if (arity() != nArgs) {
			throw new ArityException("Expected " + arity() + " arguments, got "
					+ nArgs);
		}
	}
